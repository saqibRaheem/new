...
const UpdateQuestionPage = () => {
  ...
  const Click = () => {
    ...
    for (var i = 0; i < questions.length; i++) {
      console.log(" i ", ansList[i])
      if (ansList[i] === undefined) {
        console.log('if===', ansList[i]); 
      } else {

        console.log('else===', ansList[i]);
    ...
    console.log(selectClause.children[0].children);
                ...
                <div className="mt-10 ml-5">
                  ...
                  {/* {quest.answer === "" ? */}
                    <div className="flex items-center m-2">
                     ...
                     {/* : <h1 className="text-[#61737d] w-[500px] mt-5 font-bold tracking-widest">  {`Ans${i + 1}`}  {quest.answer}</h1>} */}
                </div>
              )
            })}
